 ...
 * 
 */
@WebServiceClient(name = "HelloObjisWSService", targetNamespace = "http://simple.demowebservice.objis.com/", wsdlLocation = "http://192.168.57.100:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.57.100:8888/hello?wsdl");
